...
_ROWS: tuple = (
    ...
    {"phase": "request", "pointer": "/stream", "field_type": "boolean",
     "normalized_pointer": "/stream", "native_enforcement": "hook_and_egress",
     "lossiness": "none", "fixture_id": "req-stream",
     "obligation": "type_value",
     "description": "stream flag must be observed, true must deny per context contract"},
    ...
    {"phase": "request", "pointer": "/messages/1/content_parts_image", "field_type": "content_part",
     "normalized_pointer": None, "native_enforcement": "reject_before_normalization",
